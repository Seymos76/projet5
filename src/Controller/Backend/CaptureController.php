...
class CaptureController extends Controller
{
     ...
     * @return Response
     */
    public function addCaptureAction(Request $request, NAOManager $naoManager, NAOCaptureManager $naoCaptureManager, NAOUserManager $naoUserManager, NAOImage $naoImage)
    {
        $capture = new Capture();
